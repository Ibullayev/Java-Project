...
public class Main {
    public static void main(String[] args){
        ...
        naruto.addSpecialSign("Easy to watch");
        naruto.addSpecialSign("Lots of Series");
        naruto.addSpecialSign("Fantasy World");
        System.out.println(naruto);
        System.out.println("----------------");

        Anime fairy_tail = new Anime();
        fairy_tail.setTitle("Fairy Tail");
        ...
        fairy_tail.addSpecialSign("Easy to watch");
        fairy_tail.addSpecialSign("Short Series");
        fairy_tail.addSpecialSign("Fantasy World");
        System.out.println(fairy_tail);
        System.out.println("----------------");
        
        Anime one_piece = new Anime();
        one_piece.setTitle("One Piece");
        ...
        one_piece.addSpecialSign("Easy to watch");
        one_piece.addSpecialSign("Good for Kids");
        one_piece.addSpecialSign("Fantasy World");
